...
| <a id="s4"></a>S4 | 门户侧的隔离执行与审计（MCP 侧契约已迁） | 用户 | `AC4.3`–`AC4.7`（`AC4.1` / `AC4.2` → [`../mcp/mcp-stories.md`](../mcp/mcp-stories.md) `MS2`） | [`product-backlog.md`](../product-backlog.md) #4 / #11 | [Sprint 4 PSP-W2「端到端接入」](../sprint-plan.md#s4-mcp-session-bridge) | [`web-design.md`](./web-design.md) §1 / §5 | TC-P-L0-02 · TC-P-L0-03 · TC-P-L1-05 · TC-P-L1-07 · TC-P-L3-01 · TC-P-L3-05 · TC-P-L3-09 |
