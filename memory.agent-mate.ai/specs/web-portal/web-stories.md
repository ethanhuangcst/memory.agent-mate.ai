...
- **单一真源**：本文件是「要什么 / 怎样算完成」的唯一真源；设计不改写 AC，测试不改写 AC，排期只在 [`../sprint-plan.md`](../sprint-plan.md)。

### 故事索引

| # | 故事 | 角色 | AC | Product Backlog | Sprint | 设计 | 测试用例 |
|---|---|---|---|---|---|---|---|
| <a id="s1"></a>S1 | 创建用户（邀请制） | 管理员 | AC1.1–AC1.7 | [`product-backlog.md`](../product-backlog.md) #27 | Sprint 4 #3 | [`web-design.md`](./web-design.md) §4.2 | TC-P-L0-01 · TC-P-L1-01 · TC-P-L3-02 |
| <a id="s2"></a>S2 | 令牌生命周期 | 管理员 | AC2.1–AC2.9 | [`product-backlog.md`](../product-backlog.md) #3 | Sprint 4 #2 | [`web-design.md`](./web-design.md) §4.1 | TC-P-L0-04 · TC-P-L1-02 · TC-P-L3-04 |
| <a id="s3"></a>S3 | 用户通过 MCP 端点接入 | 用户 | AC3.1–AC3.7 | [`product-backlog.md`](../product-backlog.md) #14 / #28 | Sprint 4 #7 | [`web-design.md`](./web-design.md) §2 / §3.3 | TC-P-L1-03 · TC-P-L1-04 · TC-P-L1-06 · TC-P-L2-01–03 |
| <a id="s4"></a>S4 | 跨用户隔离 | 用户 | AC4.1–AC4.7 | [`product-backlog.md`](../product-backlog.md) #4 / #11 | [Sprint 4「门户 ↔ MCP 会话桥」](../sprint-plan.md#s4-mcp-session-bridge) | [`web-design.md`](./web-design.md) §3.3 / §5 | TC-P-L0-02/03 · TC-P-L1-05/07 · TC-P-L3-01/05/09 |
| <a id="s5"></a>S5 | 审计可追溯 | 管理员 | AC5.1–AC5.3 | [`product-backlog.md`](../product-backlog.md) #5 | [Sprint 4「审计视图」](../sprint-plan.md#s4-audit-view) | [`web-design.md`](./web-design.md) §4.4 | TC-P-L0-05 |
| <a id="s6"></a>S6 | 接入说明页与 i18n | 新用户 | AC6.1–AC6.6 | [`product-backlog.md`](../product-backlog.md) #7 | Sprint 4 #6 | [`web-design.md`](./web-design.md) §2 | TC-P-L2-04 · TC-P-L2-05 |
| <a id="s7"></a>S7 | 容量、配额与限流 | 管理员 | AC7.1–AC7.6 | [`product-backlog.md`](../product-backlog.md) #6 / #17 / #29 | Sprint 4 #5 · Sprint 5 #8 | [`web-design.md`](./web-design.md) §7 · [`../mcp/mcp-design.md`](../mcp/mcp-design.md) §5.4 | TC-P-L3-06 · TC-P-L3-07 |
| <a id="s8"></a>S8 | 主人保底路径不受影响 | 主人 | AC8.1–AC8.4 | [`product-backlog.md`](../product-backlog.md) #14 | [Sprint 5「接入面」](../sprint-plan.md#s5-access-surfaces) | [`web-design.md`](./web-design.md) §2 | TC-P-L1-08 |
| <a id="s9"></a>S9 | 门户自身数据的边界 | 运维 | AC9.1–AC9.4 | [`product-backlog.md`](../product-backlog.md) #9 / #26 | Sprint 5 #7 | [`web-design.md`](./web-design.md) §4.4 / §11 | TC-P-L1-10 · TC-P-L3-08 |
| <a id="s10"></a>S10 | 管理面访问控制与面隔离 | 管理员 | AC10.1–AC10.5 | [`product-backlog.md`](../product-backlog.md) #2 / #16 | Sprint 4 #1 / #8 | [`web-design.md`](./web-design.md) §6 | TC-P-L3-03 |
| <a id="s11"></a>S11 | 门户启动自检（fail-closed） | 运维 | AC11.1–AC11.5 | [`product-backlog.md`](../product-backlog.md) #18 | Sprint 4 #9 | [`web-design.md`](./web-design.md) §3.4 | TC-P-L0-06 · TC-P-L0-07 · TC-P-L0-08 · TC-P-L0-09 |
| <a id="s12"></a>S12 | 门户制品契约与升级治理 | 运维 | AC12.1–AC12.5 | [`product-backlog.md`](../product-backlog.md) #18 | Sprint 4 #9 · Sprint 6 #3 | [`web-design.md`](./web-design.md) §3.1 / §3.2 / §9 | TC-P-L1-09 · TC-P-L1-11 · TC-P-L1-12 |
| <a id="s13"></a>S13 | 门户容器最小攻击面 | 运维 | AC13.1–AC13.3 | [`product-backlog.md`](../product-backlog.md) #16 · [`../adr/ADR-012`](../adr/ADR-012-portal-launch-mechanism-no-docker-socket.md) | Sprint 4 #7 / #8 | [`web-design.md`](./web-design.md) §3 / §8 T1 | TC-P-L1-08 · TC-P-L1-13 |
